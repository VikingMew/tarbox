...
#### 16. 高级存储特性
- **文件**: [16-advanced-storage.md](16-advanced-storage.md)
- **状态**: 📅 待实现
...
2. **[16. 高级存储](16-advanced-storage.md)** - 分层、文本、审计表
...
- 2026-01-17: 拆分 spec/01 为 MVP 核心和高级存储（spec/16-advanced-storage.md）
